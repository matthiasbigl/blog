...
const SEO = ({
  ...
  const defaultDescription =
    "Personal blog by Matthias Bigl (Bigl) - Exploring technology, software development, design, and innovation. Follow Bigl's journey through the tech world."
  ...
  const defaultKeywords =
    'Matthias Bigl, Bigl, Matthias Bigl blog, Bigl blog, tech blog, software development, web development, programming, technology'
  ...
  return (
    <Head>
      ...
      <meta
        name="keywords"
        content={
          tags ? `${defaultKeywords}, ${tags.join(', ')}` : defaultKeywords
        }
      />
      ...
      {article && publishedTime && (
        <meta
          ...
          content={publishedTime.split('T')[0]}
        />
      )}
