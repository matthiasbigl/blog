      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0 text-center md:text-left">
            ...
            <p className="text-sm text-light-muted dark:text-dark-muted mt-2 max-w-md">
              Personal blog by <strong>Matthias Bigl</strong> — Exploring
              technology, software development, and innovation.{' '}
              <a
                href="https://bigls.net"
                target="_blank"
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <div className="flex space-x-6">
              ...
              <a
                ...
                title="Matthias Bigl – bigls.net"
                aria-label="Visit bigls.net"
              >
                <Contact size={20} />
              </a>
        ...
        <div className="mt-8 pt-6 border-t border-light-border dark:border-dark-border text-center">
          <p className="text-xs text-light-muted dark:text-dark-muted">
            Bigl's Blog is the personal technology blog of{' '}
            <a
              href="https://bigls.net"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              Matthias Bigl (bigls.net)
            </a>
            , featuring articles on software development, web technologies, and
            tech insights.
          </p>
        </div>
      </div>
